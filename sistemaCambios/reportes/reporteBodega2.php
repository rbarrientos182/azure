...
$header = array('Ruta','SKU','Producto','Cant. Pzas','Defecto Producción','Merma Operativa','Producto Caduco','Retiro Para Donativo');

// Anchuras de las columnas
$w = array(8,8,50,15,30,30,30,30);
$pdf->SetFont('Times','',9);
$pdf->AddPage();
