...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // Movernos a la derecha
        $this->Cell(30);
        $this->Cell(60,5,'Reporte Vendedor',0,0,'L');
...
$header = array('VPP','PPP','Nud','Cliente','SKU','Producto','Agrupador','Motivo','Cant. Pzas','Nota');
...
$pdf->Output('reporteVendedor_'.$fechaIni.'_'.date('H:i:s').'.pdf','D');
?>
