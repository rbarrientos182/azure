...
$header = array('VPP','PPP','Nud','Cliente','SKU','Producto','SKU Conv.','Producto Conv.','Cant. Pzas','');
...
$pdf->Output('reporteVendedor_'.$fechaPreventa.'_'.date('H:i:s').'.pdf','D');
?>