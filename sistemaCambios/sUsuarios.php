...
<div>
	<ul class="breadcrumb">
		...
		<li>
			<a href="sUsuarios.php">Subir Usuarios</a>
		</li>
	</ul>
</div>
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-upload"></i>Subir Usuarios</h2>
			<div class="box-icon">
				<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
			</div>
		</div>
		<div class="box-content">
            <form class="form-horizontal" enctype="multipart/form-data" action="sFileUsuarios.php" method="post">
            	<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							...
							<div id="uploadFile" style=" display:none">
								Subiendo Usuarios no cierre la ventana<img src="img/ajax-loaders/ajax-loader-7.gif" title="img/ajax-loaders/ajax-loader-7.gif">
							</div>
						</div>
					</div>
