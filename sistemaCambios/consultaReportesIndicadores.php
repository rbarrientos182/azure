...
?>
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="consultaReportesIndicadores.php">Reportes Indicadores</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Reportes Indicadores</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" id="registro" action="reportes/consultarReportesIndicadores.php" method="post" target="_blank">
							<fieldset>
