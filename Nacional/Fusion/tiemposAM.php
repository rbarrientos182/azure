...
FROM resumen_ruta 
WHERE fechaOperacion = DATE_SUB(CURRENT_DATE,INTERVAL $intervalo DAY) AND iddeposito = $iddeposito AND tipoRuta = 6 AND CURRENT_TIME < '13:00:00' ORDER BY firmaElectroncia";
